...
class SilverTransformer:
    ...
    def transform_users(self) -> Tuple[int, Dict]:
        ...
        try:
            ...
            # Parse JSON fields (already dicts from jsonb)
            ...
            # Filter out user_ids already in silver.clean_users
            with self.engine.connect() as conn:
    ...
    def transform_covid_data(self) -> Tuple[int, Dict]:
        ...
        try:
            ...
            def calculate_quality_score(row):
                ...
                # Outlier detection (cases > 10M or deaths > 500K)
            ...
            # Remove duplicates by record_date, country, province
    ...
    def run(self):
        ...
        # Truncate silver.clean_users before transformation
        with self.engine.connect() as conn:
        ...
        # Note: Add similar transformations for posts and ecommerce data
